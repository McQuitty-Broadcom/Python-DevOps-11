...
- Your login: is mfwsuser11@demo.broadcom.com
...
- Your userid is CUST011.
- Your password CUST011.
...
- Run the following commands and ensure we get a 0000 return code:
  - `zowe endevor generate DOGGOS11 --type COBOL --os --maxrc 0 --sn 1 --cb`
  - `zowe endevor generate DOGGOS11 --type LNK --os --maxrc 0 --sn 1 --cb`
...
- To execute the application and see the output, we can call `zowe jobs`.
  - `zowe jobs submit dataset CUST011.PUBLIC.JCL(NDRUNDOG) --vasc`
...
`zowe jobs submit data-set "CUST011.MARBLES.JCL(MARBCOPY)" --vasc`
...
Username: _JENKINSCUST011
Password: Mfuser11@26
...
The repository URL will be `https://github.com/McQuitty-Broadcom/Python-DevOps-11.git`
